...
namespace DeepQLearning.DRLAgent {
    ...
    public class Vec {
        ...
        public Vec rotate(double a) {  // CLOCKWISE
    ...
    public class Eye {
        ...
        public Eye(/*double angle*/int slot) {
            this.slot = slot; // which slot this eye is located in
            //this.angle = angle; // angle of the eye relative to the agent
            this.max_range = 8000; // maximum proximity range
